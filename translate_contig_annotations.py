...
def translate_annotations(predicted_genes_file, alignment_coords_file, output_file, \
    ...
    """ Translate annotation coordinates back to reference sequences. 
        ...
        reference_name denotes the sequence identifier to be used 
        in the first field of the resulting gff file. 
    """ 
...
if __name__=="__main__":
    args = interface() 
    translate_annotations(args.predicted_genes, args.alignment_coords, args.output_file)
